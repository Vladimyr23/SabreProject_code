...
def actions():
    ...
    def make_mesh(o3dvis):
        ...
        o3dvis.add_geometry({"name": RESULT_NAME, "pcd": mesh})
...
def selections():
    ...
    def do_icp_one_set(o3dvis):
        ...
        # Update the source pcd
        o3dvis.remove_geometry(source_name)
        o3dvis.add_geometry({"name": source_name, "pcd": source})
...
def time_animation():
    ...
    clouds = [{"name": "t=0", "pcd": orig, "time": 0}]
...
def remove():
    ...
    bbox = {
        "name": "bbox",
        "pcd": red["pcd"].get_axis_aligned_bounding_box()
    }
