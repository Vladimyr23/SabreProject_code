...
class AppWithGUI(tk.Tk):
    ...
    def create_menu_buttons(self):
        ...
        self.sabre_hw_image_lbl.grid(row=0, column=4, columnspan=1, rowspan=14, padx=3, pady=15, sticky='nsew')
        ...
        self.visualize_real_time_button.grid(row=10, column=0, columnspan=3, sticky='nsew')
        ...
        self.source_color_btn.grid(row=11, column=0, sticky='nsew')
        # Chosen source color label
        self.source_color_lbl = Label(self, text="Source", bg=("#FFB400"))
        self.source_color_lbl.grid(row=11, column=1)
        ...
        self.target_color_btn.grid(row=12, column=0, sticky='nsew')
        # Chosen target color label
        self.target_color_lbl = Label(self, text="Target", bg=("#00A6ED"))
        self.target_color_lbl.grid(row=12, column=1)
        ...
        self.close_vis_button.grid(row=13, column=0, columnspan=3, sticky='nsew')
        ...
        self.quit_button.grid(row=14, column=0, columnspan=3, sticky='nsew')
